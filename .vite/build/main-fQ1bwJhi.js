...
require$$0.app.whenReady().then(() => {
  if (!require$$0.app.isPackaged) {
    Promise.resolve().then(() => require("./index-D3rBMC78.js")).then((n) => n.index).then((mymodule) => {
  ...
  require$$0.protocol.handle("accompany", (request) => {
    let url = request.url.replace("accompany://", "");
